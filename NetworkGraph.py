...
class NetworkGraph:
    ...
    def generate_network_graph(self):
        ...
        while is_graph_needed:
            ...
            print(" Anetwork_graphfffffffffff " + str(self.network_graph) + "\n")
            print(" Nodessssss " + str(self.network_graph.nodes()) + "\n")
            print(" Edgeeeeeee " + str(self.network_graph.edges()) + "\n")
            self.graph_matrix = nx.to_numpy_array(self.network_graph)
            print(" Adjacency Matrixxxxxxxxxxxxx " + str(self.graph_matrix) + "\n")
    ...
    def instantiate_all_nodes(self):
        ...
        print("Generate b for Node 0:  \n" + str(self.b[0]))

        self.b_sum = np.sum(self.b, 0)

        print("b_sum:\n" + str(self.b_sum))
        # Instantiating the function class using the sum of all B vectors.
        simulationFunctionXTX_BTX = SimulationFunctionXTX_BTX(self.b_sum,self.b)
        ...
        #print("Generate b for all nodes????????????:\n" + str(simulationFunctionXTX_BTX.get_min_fn_i(2)))

       # Added - Start


         #simulationFunctionXTX_BTX.get_min_fn_i(self,1)
       ...
       #  Added - Start
        ...
        for i in range(self.simulation_specification.number_of_nodes):
            node = Node(i,
                        ...
                        simulationFunctionXTX_BTX.get_min_fn_i(i),
